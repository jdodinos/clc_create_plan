...
/**
 * Class ConfigVoiceCreatePlanForm to configure the packages.
 */
class ConfigVoiceCreatePlanForm extends FormBase {
  /**
   * Request stack.
   *
  ...
  /**
   * Constructs a new ConfigVoiceCreatePlanForm.
   *
  ...
  public function getFormId() {
    return 'config_voice_create_plan_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['voice'] = [
      '#type' => 'fieldset',
      '#title' => $this->t('Ingresar nuevo Paquetes solo Voz'),
      '#tree' => TRUE,
      'package_id' => [
        '#type' => 'textfield',
      ...
      'quantity' => [
        ...
        '#description' => $this->t('Select the number of minuts'),
        '#options' => $quantities,
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($triggering['#name'] == 'save_voice') {
      $values = $form_state->getValue('voice');

      // Save the configuration.
      $quantity = $values['quantity'] . ' Minutos';
      $fields = [
        'type' => 'voice',
        'name' => 'Solo Voz ' . $quantity,
        'status' => 0,
        'minuts' => $values['quantity'],
        'internet' => NULL,
